...
namespace Comdata.AppSupport.AppTools
{
    public class TextLogger :ILog
    {
        ...
        Severity _loggingThreshold     = Severity.Info;
        ...
        /// </summary>
        public Severity LoggingThreshold
        {
            get { return _loggingThreshold; }
            set { _loggingThreshold = value; }
        }
        ...
        public TextLogger(string logPath)
        {
            ...
            _logIsOpen = false;
            _addTimeStamp = true;
            _addSeverityLevel = true;
            _loggingThreshold = Severity.Info;
        }
        ...
        /// 
        /// <paramref name="logPath"/> The path where the lag will be saved  
        /// <paramref name="loggingThreshold"/> The current logging threshold  
        /// </summary>
        /// <param name="logPath"></param>
        public TextLogger(string logPath, Severity loggingThreshold)
        {
            if (!Directory.Exists(logPath))
                Directory.CreateDirectory(logPath);
        ...
        /// </summary>
        /// <param name="logPath"></param>
        public TextLogger(string logPath, string logFilename)
        {
            if (!Directory.Exists(logPath))
                Directory.CreateDirectory(logPath);
        ...
        /// </summary>
        /// <param name="logPath"></param>
        public TextLogger(string logPath, string logFilename, Severity loggingThreshold)
        {
            if (!Directory.Exists(logPath))
                Directory.CreateDirectory(logPath);
        ...
        {
            if (_currentSeverityLevel < _loggingThreshold)
                return;
